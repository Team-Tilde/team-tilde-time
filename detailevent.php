<?php
	...
	if (isset($_GET['event']))
	{
		...
		$sql = "SELECT e.event_id, e.title, e.description, e.location, e.public, e.private, e.date_time_start, e.date_time_end, t.description as tdescription, tc.description as tcdescription FROM Event as e, Task as t, TaskCategory as tc WHERE e.event_id = '" . $eventID . "' AND e.task_id=t.task_id AND t.task_category_id=tc.task_category_id";
