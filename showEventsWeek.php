	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			echo "<tr>
					...
					<td width='25%'><p>" . $row['description'] . "</p></td>
					...
					<td width='10%'><p><a href='#'" . $row['event_id'] . " title='"  . $row['event_id'] . "' onclick='showEventDetails(this.title)'><span class='glyphicon glyphicon-search'></span></a>
